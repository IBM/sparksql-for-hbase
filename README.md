...
Please find the table creation commands in the [scripts](tree/master/scripts) folder. There you will find 5 commands that you need to cut and paste into the HSpark Shell.
...
HSpark can import CSV data files that you generate by using the TPC-DS tool. A sample `csv_file` can be found in the [data](tree/master/data) folder. 
...
More query examples can be found in the [scripts](tree/master/scripts) folder, along with expected output from each of the queries.
